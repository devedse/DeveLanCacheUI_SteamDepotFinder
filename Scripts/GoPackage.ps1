...
$7zFilePath = Join-Path $outputDir "DeveLanCacheUI_SteamDepotFinder.7z"
$zipFilePath = Join-Path $outputDir "DeveLanCacheUI_SteamDepotFinder.zip"

DeleteFileIfExists $7zFilePath
DeleteFileIfExists $zipFilePath
DeleteFolderIfExists $outputDir

$buildPath = Join-Path $solutionRoot "DeveLanCacheUI_SteamDepotFinder\bin\Release\net7.0"
